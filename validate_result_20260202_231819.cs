// Random C# class generated on 2026-02-02
using System;
using System.Collections.Generic;
using System.ComponentModel;

public class HandleUser : INotifyPropertyChanged
{
    ...
    public HandleUser(string name, int value = 34)
    {
        _name = name;
        _value = value;
    ...
    {
        return $"HandleUser { Name = {Name}, Value = {Value}, CreatedAt = {CreatedAt} }";
    }
}
