// Random C function generated on 2025-10-18
#include <stdio.h>
#include <stdlib.h>
#include <string.h>
...
Item* validate_item(const Item* items, int count, int* result_count) {
...
int main() {
    ...
    int result_count;
    Item* result = validate_item(testData, 2, &result_count);
