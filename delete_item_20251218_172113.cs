// Random C# class generated on 2025-12-18
using System;
using System.Collections.Generic;
using System.ComponentModel;

public class CreateItem : INotifyPropertyChanged
{
    ...
    public CreateItem(string name, int value = 48)
    {
        _name = name;
        _value = value;
    ...
    {
        return $"CreateItem { Name = {Name}, Value = {Value}, CreatedAt = {CreatedAt} }";
    }
}
