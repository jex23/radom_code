// Random C# class generated on 2025-09-16
using System;
using System.Collections.Generic;
using System.ComponentModel;

public class SetUser : INotifyPropertyChanged
{
    ...
    public SetUser(string name, int value = 63)
    {
        _name = name;
        _value = value;
    ...
    {
        return $"SetUser { Name = {Name}, Value = {Value}, CreatedAt = {CreatedAt} }";
    }
}
