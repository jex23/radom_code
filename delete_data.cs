// Random C# class generated on 2025-07-17
using System;
using System.Collections.Generic;
using System.ComponentModel;

public class GetConfig : INotifyPropertyChanged
{
    ...
    public GetConfig(string name, int value = 84)
    {
        _name = name;
        _value = value;
    ...
    {
        return $"GetConfig { Name = {Name}, Value = {Value}, CreatedAt = {CreatedAt} }";
    }
}
