// Random C# class generated on 2025-11-18
using System;
using System.Collections.Generic;
using System.ComponentModel;

public class CreateValue : INotifyPropertyChanged
{
    ...
    public CreateValue(string name, int value = 93)
    {
        _name = name;
        _value = value;
    ...
    {
        return $"CreateValue { Name = {Name}, Value = {Value}, CreatedAt = {CreatedAt} }";
    }
}
