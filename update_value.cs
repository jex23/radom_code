// Random C# class generated on 2025-08-07
using System;
using System.Collections.Generic;
using System.ComponentModel;

public class DeleteData : INotifyPropertyChanged
{
    ...
    public DeleteData(string name, int value = 61)
    {
        _name = name;
        _value = value;
    ...
    {
        return $"DeleteData { Name = {Name}, Value = {Value}, CreatedAt = {CreatedAt} }";
    }
}
