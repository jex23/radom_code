// Random C# class generated on 2025-12-03
using System;
using System.Collections.Generic;
using System.ComponentModel;

public class ProcessResult : INotifyPropertyChanged
{
    ...
    public ProcessResult(string name, int value = 54)
    {
        _name = name;
        _value = value;
    ...
    {
        return $"ProcessResult { Name = {Name}, Value = {Value}, CreatedAt = {CreatedAt} }";
    }
}
