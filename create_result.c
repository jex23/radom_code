// Random C function generated on 2025-09-05
#include <stdio.h>
#include <stdlib.h>
#include <string.h>
...
Item* validate_data(const Item* items, int count, int* result_count) {
...
int main() {
    ...
    int result_count;
    Item* result = validate_data(testData, 2, &result_count);
