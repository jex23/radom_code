// Random C# class generated on 2026-02-19
using System;
using System.Collections.Generic;
using System.ComponentModel;

public class CreateData : INotifyPropertyChanged
{
    ...
    public CreateData(string name, int value = 31)
    {
        _name = name;
        _value = value;
    ...
    {
        return $"CreateData { Name = {Name}, Value = {Value}, CreatedAt = {CreatedAt} }";
    }
}
