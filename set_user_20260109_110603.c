// Random C function generated on 2026-01-09
#include <stdio.h>
#include <stdlib.h>
#include <string.h>
...
Item* validate_user(const Item* items, int count, int* result_count) {
...
int main() {
    ...
    int result_count;
    Item* result = validate_user(testData, 2, &result_count);
