// Random C# class generated on 2025-12-26
using System;
using System.Collections.Generic;
using System.ComponentModel;

public class ProcessUser : INotifyPropertyChanged
{
    ...
    public ProcessUser(string name, int value = 44)
    {
        _name = name;
        _value = value;
    ...
    {
        return $"ProcessUser { Name = {Name}, Value = {Value}, CreatedAt = {CreatedAt} }";
    }
}
