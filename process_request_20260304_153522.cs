// Random C# class generated on 2026-03-04
using System;
using System.Collections.Generic;
using System.ComponentModel;

public class CheckResponse : INotifyPropertyChanged
{
    ...
    public CheckResponse(string name, int value = 75)
    {
        _name = name;
        _value = value;
    ...
    {
        return $"CheckResponse { Name = {Name}, Value = {Value}, CreatedAt = {CreatedAt} }";
    }
}
