// Random C# class generated on 2025-09-24
using System;
using System.Collections.Generic;
using System.ComponentModel;

public class ValidateResponse : INotifyPropertyChanged
{
    ...
    public ValidateResponse(string name, int value = 46)
    {
        _name = name;
        _value = value;
    ...
    {
        return $"ValidateResponse { Name = {Name}, Value = {Value}, CreatedAt = {CreatedAt} }";
    }
}
