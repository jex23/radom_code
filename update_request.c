// Random C function generated on 2025-08-18
#include <stdio.h>
#include <stdlib.h>
#include <string.h>
...
Item* create_request(const Item* items, int count, int* result_count) {
...
int main() {
    ...
    int result_count;
    Item* result = create_request(testData, 2, &result_count);
