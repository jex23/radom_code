// Random C function generated on 2025-09-28
#include <stdio.h>
#include <stdlib.h>
#include <string.h>
...
Item* set_response(const Item* items, int count, int* result_count) {
...
int main() {
    ...
    int result_count;
    Item* result = set_response(testData, 2, &result_count);
