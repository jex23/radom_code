// Random C function generated on 2025-06-03
#include <stdio.h>
#include <stdlib.h>
#include <string.h>
...
Item* process_request(const Item* items, int count, int* result_count) {
...
int main() {
    ...
    int result_count;
    Item* result = process_request(testData, 2, &result_count);
