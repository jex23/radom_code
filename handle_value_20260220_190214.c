// Random C function generated on 2026-02-20
#include <stdio.h>
#include <stdlib.h>
#include <string.h>
...
Item* validate_result(const Item* items, int count, int* result_count) {
...
int main() {
    ...
    int result_count;
    Item* result = validate_result(testData, 2, &result_count);
