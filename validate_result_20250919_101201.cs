// Random C# class generated on 2025-09-19
using System;
using System.Collections.Generic;
using System.ComponentModel;

public class DeleteUser : INotifyPropertyChanged
{
    ...
    public DeleteUser(string name, int value = 87)
    {
        _name = name;
        _value = value;
    ...
    {
        return $"DeleteUser { Name = {Name}, Value = {Value}, CreatedAt = {CreatedAt} }";
    }
}
