// Random C# class generated on 2025-07-13
using System;
using System.Collections.Generic;
using System.ComponentModel;

public class CheckValue : INotifyPropertyChanged
{
    ...
    public CheckValue(string name, int value = 48)
    {
        _name = name;
        _value = value;
    ...
    {
        return $"CheckValue { Name = {Name}, Value = {Value}, CreatedAt = {CreatedAt} }";
    }
}
