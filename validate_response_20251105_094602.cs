// Random C# class generated on 2025-11-05
using System;
using System.Collections.Generic;
using System.ComponentModel;

public class CreateRequest : INotifyPropertyChanged
{
    ...
    public CreateRequest(string name, int value = 93)
    {
        _name = name;
        _value = value;
    ...
    {
        return $"CreateRequest { Name = {Name}, Value = {Value}, CreatedAt = {CreatedAt} }";
    }
}
