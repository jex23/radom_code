// Random C# class generated on 2025-12-01
using System;
using System.Collections.Generic;
using System.ComponentModel;

public class CreateUser : INotifyPropertyChanged
{
    ...
    public CreateUser(string name, int value = 28)
    {
        _name = name;
        _value = value;
    ...
    {
        return $"CreateUser { Name = {Name}, Value = {Value}, CreatedAt = {CreatedAt} }";
    }
}
