// Random C function generated on 2025-06-29
#include <stdio.h>
#include <stdlib.h>
#include <string.h>
...
Item* check_config(const Item* items, int count, int* result_count) {
...
int main() {
    ...
    int result_count;
    Item* result = check_config(testData, 2, &result_count);
