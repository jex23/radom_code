// Random C# class generated on 2025-11-11
using System;
using System.Collections.Generic;
using System.ComponentModel;

public class DeleteResponse : INotifyPropertyChanged
{
    ...
    public DeleteResponse(string name, int value = 62)
    {
        _name = name;
        _value = value;
    ...
    {
        return $"DeleteResponse { Name = {Name}, Value = {Value}, CreatedAt = {CreatedAt} }";
    }
}
