// Random C# class generated on 2025-07-08
using System;
using System.Collections.Generic;
using System.ComponentModel;

public class UpdateValue : INotifyPropertyChanged
{
    ...
    public UpdateValue(string name, int value = 25)
    {
        _name = name;
        _value = value;
    ...
    {
        return $"UpdateValue { Name = {Name}, Value = {Value}, CreatedAt = {CreatedAt} }";
    }
}
