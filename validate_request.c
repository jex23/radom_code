// Random C function generated on 2025-10-13
#include <stdio.h>
#include <stdlib.h>
#include <string.h>
...
Item* delete_result(const Item* items, int count, int* result_count) {
...
int main() {
    ...
    int result_count;
    Item* result = delete_result(testData, 2, &result_count);
