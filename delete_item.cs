...
public class DeleteRequest : INotifyPropertyChanged
{
    ...
    public DeleteRequest(string name, int value = 17)
    {
        _name = name;
        _value = value;
    ...
    {
        return $"DeleteRequest { Name = {Name}, Value = {Value}, CreatedAt = {CreatedAt} }";
    }
}
