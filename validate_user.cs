// Random C# class generated on 2025-07-18
using System;
using System.Collections.Generic;
using System.ComponentModel;

public class ProcessRequest : INotifyPropertyChanged
{
    ...
    public ProcessRequest(string name, int value = 83)
    {
        _name = name;
        _value = value;
    ...
    {
        return $"ProcessRequest { Name = {Name}, Value = {Value}, CreatedAt = {CreatedAt} }";
    }
}
