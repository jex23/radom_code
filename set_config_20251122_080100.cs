// Random C# function generated on 2025-11-22
using System;
...
{
    public static List<HandleConfig> Delete_value(IEnumerable<HandleConfig> items)
    {
    ...
    public static void Main()
    {
        ...
        {
            new HandleConfig(1, "Item1", 40),
            new HandleConfig(2, "Item2", 97)
        };
