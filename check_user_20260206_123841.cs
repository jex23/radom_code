// Random C# class generated on 2026-02-06
using System;
using System.Collections.Generic;
using System.ComponentModel;

public class HandleItem : INotifyPropertyChanged
{
    ...
    public HandleItem(string name, int value = 1)
    {
        _name = name;
        _value = value;
    ...
    {
        return $"HandleItem { Name = {Name}, Value = {Value}, CreatedAt = {CreatedAt} }";
    }
}
