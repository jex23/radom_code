// Random C function generated on 2026-01-07
#include <stdio.h>
#include <stdlib.h>
#include <string.h>
...
Item* process_user(const Item* items, int count, int* result_count) {
...
int main() {
    ...
    int result_count;
    Item* result = process_user(testData, 2, &result_count);
