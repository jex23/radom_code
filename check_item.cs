// Random C# class generated on 2025-08-25
using System;
using System.Collections.Generic;
using System.ComponentModel;

public class CheckConfig : INotifyPropertyChanged
{
    ...
    public CheckConfig(string name, int value = 72)
    {
        _name = name;
        _value = value;
    ...
    {
        return $"CheckConfig { Name = {Name}, Value = {Value}, CreatedAt = {CreatedAt} }";
    }
}
