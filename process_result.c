// Random C function generated on 2025-06-26
#include <stdio.h>
#include <stdlib.h>
#include <string.h>
...
Item* handle_result(const Item* items, int count, int* result_count) {
...
int main() {
    ...
    int result_count;
    Item* result = handle_result(testData, 2, &result_count);
