// Random C# class generated on 2026-02-20
using System;
using System.Collections.Generic;
using System.ComponentModel;

public class ValidateRequest : INotifyPropertyChanged
{
    ...
    public ValidateRequest(string name, int value = 97)
    {
        _name = name;
        _value = value;
    ...
    {
        return $"ValidateRequest { Name = {Name}, Value = {Value}, CreatedAt = {CreatedAt} }";
    }
}
